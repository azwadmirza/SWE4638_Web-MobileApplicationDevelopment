    ...
    return (
        <div className="w-full mt-24">
            ...
            <div className="w-full text-black flex justify-center mb-4">
                <button onClick={() => saveQuiz()} className="bg-green-800 text-white py-2 px-4 rounded-lg mt-4 me-4 hover:bg-green-600">Save Quiz</button>
                <button onClick={() => discardQuiz()} className="bg-red-800 text-white py-2 px-4 rounded-lg mt-4 me-4 hover:bg-red-600">Discard Quiz</button>
            </div>
